...
graph.add_netisim_edge(2, 4, bandwidth='400Gbps', delay='20ns')
graph.add_netisim_edge(3, 4, bandwidth='400Gbps', delay='20ns')
graph.add_netisim_edge(2, 5, bandwidth='400Gbps', delay='20us')
graph.add_netisim_edge(3, 5, bandwidth='400Gbps', delay='20us')
graph.add_netisim_edge(2, 6, bandwidth='400Gbps', delay='20us')
graph.add_netisim_edge(3, 6, bandwidth='400Gbps', delay='20us')
