# Experiment Spec: spray-latency-packet-hash

## Goal

Validate the pre-registered routing claim for block `spray-latency`.

## Topology

- family: `micro-extreme-equal`
...
Packet spray uses the 20 us path and increases short-flow tail latency.
