# Experiment Spec: all-delay-all

## Goal

Validate the pre-registered routing claim for block `all-delay`.

## Topology

- family: `micro-all-delay`
...
Delayed detours increase path stretch and reordering.
