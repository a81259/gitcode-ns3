# Experiment Spec: hash-many-toeplitz

## Goal

Validate the pre-registered routing claim for block `hash-many`.
...
Many flows remain path-affine and distribute across spine paths.
